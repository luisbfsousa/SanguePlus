...
VALUES  
    ('M0001', 'Luis Sousa', 'M', 21, 932102312),
    ('M0002', 'Vasco Rodrigues', 'M', 22, 910123453),
    ('M0003', 'Valeria Teixeira', 'F', 23, 912223408),
    ('M0004', 'Daniela Dias', 'F', 24, 923928321),
    ('M0005', 'Goncalo Oliveira', 'M', 25, 952832842),
    ('E0001', 'Guilherme Santos', 'M', 26, 913913293),
    ('E0002', 'Irina Osorio', 'F', 27, 987462231),
    ('E0003', 'Carolina Faustino', 'F', 28, 987654321),
    ('E0004', 'Laura Teixeira', 'F', 29, 936583721),
    ('E0005', 'Tiago Simoes', 'M', 20, 934585732),
    ('P0001', 'Eduardo Gomes', 'M', 30, 912345678),
    ('P0002', 'Beatriz Oliveira', 'F', 31, 923456789),
    ('P0003', 'Goncalo Borges', 'M', 32, 934567890),
    ('P0004', 'Viviana Silva', 'F', 33, 945678901),
    ('P0005', 'Pedro Cruz', 'M', 34, 956789012),
    ('D0001', 'Joao Cruz', 'M', 35, 967890123),
    ('D0002', 'Sofia Almeida', 'F', 36, 978901234),
    ('D0003', 'Diogo Costa', 'M', 37, 989012345),
    ('D0004', 'Tatiana Cruz', 'F', 38, 990123456),
    ('D0005', 'Sergio Oliveira', 'M', 39, 901234567);

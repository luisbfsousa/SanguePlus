...
CREATE TABLE SanguePlus_Clinica(
    NIF int NOT NULL,
    Nome varchar(512) NOT NULL,
    Morada varchar(512) NOT NULL,
    Contacto int NOT NULL,
    NumeroCliente varchar(512) NOT NULL,
    PRIMARY KEY (NIF),
    FOREIGN KEY (NumeroCliente) REFERENCES SanguePlus_Pessoa(Numero)
)
GO
...
CREATE TABLE SanguePlus_CartaoDador(
    ...
    EntidadeFornecedor int NOT NULL,
    PRIMARY KEY (NDador),
    FOREIGN KEY (NDador) REFERENCES SanguePlus_Dador(NDador),
    FOREIGN KEY (EntidadeFornecedor) REFERENCES SanguePlus_Clinica(NIF)
)
GO
